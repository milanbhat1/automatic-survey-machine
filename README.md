...
This module controls the autonomous movement of the robot using an ultrasonic sensor and DC motors.

- **Path:** `obstacle_avoidance/obstacle_avoidance_robot.ino`
- **Key features:**
...
This module acquires real-time gyroscope data and streams it wirelessly to a browser-based dashboard.

- **Path:** `gyro_web_visualization/esp8266_gyro_websocket.ino`
- **Key features:**
  - MPU6050 gyroscope data acquisition
  - Wi-Fi web server and WebSocket communication
...
<p align="center">
  ...
  <img src="images/hardware_setup2.jpg" width="45%">
</p>
...
<p align="center">
  <img src="images/web_plot.jpg" width="70%">
</p>
